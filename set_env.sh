...
CUDA_VISIBLE_DEVICES=5,6 python3 tools/train.py configs/smpl/gpu2/my_pretrain.py --create_dummy
CUDA_VISIBLE_DEVICES=5,6 python3 tools/train.py configs/smpl/gpu2/my_pretrain.py --gpus=2

# 180k iteration # 60220 * 3
CUDA_VISIBLE_DEVICES=5,6 python3 tools/train.py configs/smpl/gpu2/my_baseline.py --load_pretrain ./work_dirs/gpu2/pretrain/latest.pth
CUDA_VISIBLE_DEVICES=5,6 python3 tools/train.py configs/smpl/gpu2/my_baseline.py  --gpus=2

# 100k iteration # 60220 * 2
CUDA_VISIBLE_DEVICES=5,6 python3 tools/train.py configs/smpl/gpu2/my_tune.py --load_pretrain ./work_dirs/gpu2/baseline/latest.pth
CUDA_VISIBLE_DEVICES=5,6 python3 tools/train.py configs/smpl/gpu2/my_tune.py --gpus=2
